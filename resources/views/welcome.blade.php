    ...
    <div class="container text-center my-5">
        ...
        <div class="col-md-2 offset-md-5 mt-4">
            <div class="d-grid gap-2">
                <a class="btn btn-dark" href="{{ route('dashboard-admin.index') }}">admin</a>
                <a class="btn btn-dark"href="{{ route('login') }}" class="btn btn-outline-light my-2 ms-md-auto">Login</a>
                <a class="btn btn-dark"href="{{ route('register') }}" class="btn btn-outline-light my-2 ms-md-2">Register</a>
            </div>
        </div>
    </div>
